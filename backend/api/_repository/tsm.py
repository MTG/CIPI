...
def apply_tsne(pieces_list, noise_std):
    ...
    transformed_values = tsne.fit_transform(difficulty_array)
...
# Apply t-SNE to the "difficulty_predicted" values
transformed_values = apply_tsne(pieces_list, 1)
...
plt.title('t-SNE Transformed Values')
plt.show()
